...
//- Register for basicReactingCloud
...
makeInjectionModelType(implicitManualInjection, basicReactingCloud);
makeInjectionModelType(implicitCellZoneInjection, basicReactingCloud);
}
