        ...
        else
        {
            for (const entry& interfaceDictEntry : *interfaceDictPtr)
            {
                if (interfaceDictEntry.isDict())
                {
                    ...
                    auto writeData = static_cast<wordList>(interfaceDict.lookupOrDefault<wordList>("writeData", wordList()));
                    ...
                    auto readData = static_cast<wordList>(interfaceDict.lookupOrDefault<wordList>("readData", wordList()));
