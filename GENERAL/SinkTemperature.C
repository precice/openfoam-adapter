...
preciceAdapter::MODULE::SinkTemperature::SinkTemperature(
...
std::size_t preciceAdapter::MODULE::SinkTemperature::write(double* buffer, bool meshConnectivity, const unsigned int dim)
{
    int bufferIndex = 0;
...
void preciceAdapter::MODULE::SinkTemperature::read(double* buffer, const unsigned int dim)
{
    int bufferIndex = 0;
...
bool preciceAdapter::MODULE::SinkTemperature::isLocationTypeSupported(const bool meshConnectivity) const
{
...
std::string preciceAdapter::MODULE::SinkTemperature::getDataName() const
{
