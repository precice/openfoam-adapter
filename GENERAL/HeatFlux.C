...
//----- preciceAdapter::MODULE::HeatFlux_Compressible ----------------------------

preciceAdapter::MODULE::HeatFlux_Compressible::HeatFlux_Compressible(
    const Foam::fvMesh& mesh,
    const std::string nameT)
: HeatFlux(mesh, nameT),
...
void preciceAdapter::MODULE::HeatFlux_Compressible::extractKappaEff(uint patchID, bool meshConnectivity)
{
    Kappa_->extract(patchID, meshConnectivity);
}

scalar preciceAdapter::MODULE::HeatFlux_Compressible::getKappaEffAt(int i)
{
    return Kappa_->getAt(i);
}

//----- preciceAdapter::MODULE::HeatFlux_Incompressible --------------------------

preciceAdapter::MODULE::HeatFlux_Incompressible::HeatFlux_Incompressible(
    const Foam::fvMesh& mesh,
    const std::string nameT,
...
void preciceAdapter::MODULE::HeatFlux_Incompressible::extractKappaEff(uint patchID, bool meshConnectivity)
{
    Kappa_->extract(patchID, meshConnectivity);
}

scalar preciceAdapter::MODULE::HeatFlux_Incompressible::getKappaEffAt(int i)
{
    return Kappa_->getAt(i);
}

//----- preciceAdapter::MODULE::HeatFlux_Basic -----------------------------------

preciceAdapter::MODULE::HeatFlux_Basic::HeatFlux_Basic(
    const Foam::fvMesh& mesh,
    const std::string nameT,
...
void preciceAdapter::MODULE::HeatFlux_Basic::extractKappaEff(uint patchID, bool meshConnectivity)
{
    Kappa_->extract(patchID, meshConnectivity);
}

scalar preciceAdapter::MODULE::HeatFlux_Basic::getKappaEffAt(int i)
{
    return Kappa_->getAt(i);
}
