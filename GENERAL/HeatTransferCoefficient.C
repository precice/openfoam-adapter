...
//----- preciceAdapter::MODULE::HeatTransferCoefficient --------------------------

preciceAdapter::MODULE::HeatTransferCoefficient::HeatTransferCoefficient(
...
std::size_t preciceAdapter::MODULE::HeatTransferCoefficient::write(double* buffer, bool meshConnectivity, const unsigned int dim)
{
    int bufferIndex = 0;
...
void preciceAdapter::MODULE::HeatTransferCoefficient::read(double* buffer, const unsigned int dim)
{
    int bufferIndex = 0;
...
bool preciceAdapter::MODULE::HeatTransferCoefficient::isLocationTypeSupported(const bool meshConnectivity) const
{
...
std::string preciceAdapter::MODULE::HeatTransferCoefficient::getDataName() const
{
    return "HeatTransferCoefficient";
}


//----- preciceAdapter::MODULE::HeatTransferCoefficient_Compressible -------------

preciceAdapter::MODULE::
...
void preciceAdapter::MODULE::HeatTransferCoefficient_Compressible::
    extractKappaEff(uint patchID, bool meshConnectivity)
{
    Kappa_->extract(patchID, meshConnectivity);
}

scalar preciceAdapter::MODULE::HeatTransferCoefficient_Compressible::
    getKappaEffAt(int i)
{
    return Kappa_->getAt(i);
}

//----- preciceAdapter::MODULE::HeatTransferCoefficient_Incompressible -----------
...
void preciceAdapter::MODULE::HeatTransferCoefficient_Incompressible::
    extractKappaEff(uint patchID, bool meshConnectivity)
{
    Kappa_->extract(patchID, meshConnectivity);
}

scalar preciceAdapter::MODULE::HeatTransferCoefficient_Incompressible::
    getKappaEffAt(int i)
{
    return Kappa_->getAt(i);
}

//----- preciceAdapter::MODULE::HeatTransferCoefficient_Basic -----------------------------------
...
void preciceAdapter::MODULE::HeatTransferCoefficient_Basic::
    extractKappaEff(uint patchID, bool meshConnectivity)
{
    Kappa_->extract(patchID, meshConnectivity);
}

scalar preciceAdapter::MODULE::HeatTransferCoefficient_Basic::
    getKappaEffAt(int i)
{
    return Kappa_->getAt(i);
}
