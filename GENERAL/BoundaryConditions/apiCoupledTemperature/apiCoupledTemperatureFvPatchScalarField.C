...
Foam::tmp<Foam::scalarField> Foam::apiCoupledTemperatureFvPatchScalarField::getWallHeatFlux() const
{
...
Foam::tmp<Foam::scalarField> Foam::apiCoupledTemperatureFvPatchScalarField::getHeatTransferCoeff() const
{
    const scalarField& Twall(*this);
    return kappa(Twall) * patch().deltaCoeffs();
}

const Foam::scalarField& Foam::apiCoupledTemperatureFvPatchScalarField::T_Wall() const
{
    return *this;
}

Foam::tmp<Foam::scalarField> Foam::apiCoupledTemperatureFvPatchScalarField::T_Cell() const
{
...
const Foam::scalarField& Foam::apiCoupledTemperatureFvPatchScalarField::h_Neighbour() const
{
    return h_neighbour_;
}
...
const Foam::scalarField& Foam::apiCoupledTemperatureFvPatchScalarField::T_Neighbour() const
{
    return T_neighbour_;
}
...
const Foam::scalarField& Foam::apiCoupledTemperatureFvPatchScalarField::heatFlux() const
{
    return heatflux_;
}
