...
bool preciceAdapter::FF::FluidFluid::addWriters(std::string dataName, Interface* interface)
{
    ...
    if (similar(dataName, "VelocityGradient"))
    {
    ...
    else if (similar(dataName, "Velocity"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "PressureGradientFull"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "PressureGradient"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "Pressure"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "FlowTemperatureGradient"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "FlowTemperature"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "AlphaGradient"))
    {
        interface->addCouplingDataWriter(
            dataName,
    ...
    else if (similar(dataName, "Alpha"))
    {
        interface->addCouplingDataWriter(
            dataName,
...
bool preciceAdapter::FF::FluidFluid::addReaders(std::string dataName, Interface* interface)
{
    ...
    else if (similar(dataName, "DragForce"))
    {
        interface->addCouplingDataReader(
            dataName,
    ...
    else if (similar(dataName, "ExplicitMomentum"))
    {
        interface->addCouplingDataReader(
            dataName,
    ...
    else if (similar(dataName, "ImplicitMomentum"))
    {
        interface->addCouplingDataReader(
            dataName,
